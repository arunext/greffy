...
def get_post_summary(postid):
    ...
    response =  "The Top comment is:" + topcomment +  "\nThe overall polarity is {0} and subjectivity is {1}.".format(round(blob.sentiment.polarity,2),round(blob.sentiment.subjectivity,2))
